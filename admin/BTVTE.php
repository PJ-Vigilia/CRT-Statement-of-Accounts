      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="BSAIS.php">BSAIS</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="BSIT.php">BSIT</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="BTVTE.php">BTVTE</a>
            </li>
            <li class="nav-item">
      ...
      <table class="table table-bordered table-striped mb-0">
        ...
        <tbody>
          <?php
            ...
            $role2 ="student";
            $course2 = "BTVTE";
            $year_level2 = "2nd year";
            $sql2 = "SELECT * FROM users JOIN student USING(user_id) WHERE roles='$role2' AND course='$course2' AND year_level='$year_level2'";
          ...
          <tr>
            ...
            <td>
              <a href="soa.php?reciever_id=<?php echo $row2['user_id']; ?>">
                <button type="button" class="btn btn-primary btn-sm">Send Message</button>
              </a>
            </td>
          </tr>
      ...
      <table class="table table-bordered table-striped mb-0">
        ...
        <tbody>
          <?php
            ...
            $role3 ="student";
            $course3 = "BTVTE";
            $year_level3 = "3rd year";
            $sql3 = "SELECT * FROM users JOIN student USING(user_id) WHERE roles='$role3' AND course='$course3' AND year_level='$year_level3'";
          ...
          <tr>
            ...
            <td>
              <a href="soa.php?reciever_id=<?php echo $row3['user_id']; ?>">
                <button type="button" class="btn btn-primary btn-sm">Send Message</button>
              </a>
            </td>
          </tr>
      ...
      <table class="table table-bordered table-striped mb-0">
        ...
        <tbody>
          <?php
            ...
            $role4 ="student";
            $course4 = "BTVTE";
            $year_level4 = "4th year";
            $sql4 = "SELECT * FROM users JOIN student USING(user_id) WHERE roles='$role4' AND course='$course4' AND year_level='$year_level4'";
          ...
          <tr>
            ...
            <td><?php echo $row4['year_level']; ?></td>
            <td><?php echo $row4['username']; ?></td>
            <td><?php echo $row4['password']; ?></td>
            <td>
              <a href="soa.php?reciever_id=<?php echo $row4['user_id']; ?>">
                <button type="button" class="btn btn-primary btn-sm">Send Message</button>
              </a>
            </td>
          </tr>

<?php
  ...
  $sqlRID = $pdo->prepare("SELECT * FROM term_account WHERE term_id ='$term_id'");
  $sqlRID->execute();
  $RID = $sqlRID->fetch();
  $soa_reciever = $RID['reciever'];

  //user
  $sql = $pdo->prepare("SELECT * FROM users JOIN student USING(user_id) WHERE user_id ='$soa_reciever'");
  $sql->execute();
  $user = $sql->fetch();
  ...
  <div class="container" style="padding-top: 3%">
    <div class="card" style="width: 100%;">
        <div class="card-body">
          ...
          <b>PRELIM EXAMINATION</b> will be on <span id="msgDate"><?php echo $date;?></span>. Please settle your account on or before the date of examination.<br><br>
